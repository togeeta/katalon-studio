...
WebUI.click(findTestObject('delete_first_bin/Page_Gateways and Nodes - OPI Blue/span_Sites and Bins'))

WebUI.click(findTestObject('delete_first_bin/Page_Sites and Bins - OPI Blue/a_Bins'))

WebUI.click(findTestObject('delete_first_bin/Page_Sites and Bins - OPI Blue/button_Delete'))
