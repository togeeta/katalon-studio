...
WebUI.click(findTestObject('add_member/Page_Members - OPI Blue/button_ Add Member'))

WebUI.setText(findTestObject('add_member/Page_Members - OPI Blue/input_email'), 'Test-1@opisystems.com')

WebUI.click(findTestObject('add_member/Page_Members - OPI Blue/label_fa checkbox-with-label'))

WebUI.click(findTestObject('add_member/Page_Members - OPI Blue/button_Invite'))
