...
WebUI.click(findTestObject('stop_fan/Page_Dashboard - OPI Blue/a_Fan Control'))

WebUI.click(findTestObject('stop_fan/Page_Fan Control - OPI Blue/i_font-xl icon-stop-circle'))
