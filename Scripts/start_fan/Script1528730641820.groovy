...
WebUI.click(findTestObject('start_fan/Page_Dashboard - OPI Blue/a_Fan Control'))

WebUI.click(findTestObject('start_fan/Page_Fan Control - OPI Blue/i_font-xl icon-play-circled'))

WebUI.click(findTestObject('start_fan/Page_Fan Control - OPI Blue/button_Start Fan'))
