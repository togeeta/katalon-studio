...
WebUI.waitForElementPresent(findTestObject('create_bin/create_bin_ws_contd_btn/Page_Sites and Bins - OPI Blue/button_Continue'), 
    5)

WebUI.waitForElementClickable(findTestObject('create_bin/create_bin_ws_contd_btn/Page_Sites and Bins - OPI Blue/button_Continue'), 
    5)

WebUI.click(findTestObject('create_bin/create_bin_ws_contd_btn/Page_Sites and Bins - OPI Blue/button_Continue'))
