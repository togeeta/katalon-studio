...
WebUI.click(findTestObject('site_view_settings/Page_Dashboard - OPI Blue/a_Grain Condition'))

WebUI.click(findTestObject('site_view_settings/Page_Grain Condition - OPI Blue/button_View Settings'))
